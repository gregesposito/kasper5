...
{ 
	...
	/* Start - Line Entry and Count */
     char string[40] = "hello"; //Find max length of passwords - TODO
	 size_t i;
...
//for(int i = 1; i < argc; i++) {
	...
	//It seemed like the Openwall version saw a 400k increase by removing this for loop. I don't see that here.
		if (memcmp(mdString3, argv[1], 10) == 0){
